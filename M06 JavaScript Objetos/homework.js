...
function tienePropiedad(objeto, propiedad) {
   ...
   // En ese caso retornar true. Caso contrario, false.
   // Tu código:
   var loContiene = objeto.hasOwnProperty([propiedad]);
   return (loContiene);
}
...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   for (let i = 0; i < objetoMuchosUsuarios.length; i++){
      objetoMuchosUsuarios[i].esPremium = true;    //ACÁ ESTAMOS ACCEDIENDO A CADA OBJETO USUARIO Y A SU PROPIEDAD "esPremium"
   };
